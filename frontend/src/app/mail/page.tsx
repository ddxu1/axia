...
import AccountSwitcher, { AccountSwitcherRef } from '@/components/AccountSwitcher'
...
export default function Home() {
  ...
  const accountSwitcherRef = useRef<AccountSwitcherRef | null>(null)
          ...
          >
            <EmailList
              onEmailSelect={(email) => {
                ...
                accountSwitcherRef.current?.closeDropdown()
              }}
              emails={emails}
